...
import tp_outages_client.ExtensionsService;
import tp_outages_client.OutagesResource;
...
public class ExtensionsResource {
    ...
    public String testCall() {
        ...
        String test = """
                ...
                """;
        try (Response response = extensionsService.sendOutage(test.getBytes(StandardCharsets.UTF_8))) {
